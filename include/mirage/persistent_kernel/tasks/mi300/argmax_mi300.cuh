...
// MIRAGE HIP COMPAT: task_register.cc 发射的分块变体（模板带真实词表大小，
// 末参为 chunk_start，仅用于 padding 裁剪；input/output 指针已按分块偏移）。
// 语义与 blackwell/argmax_sm100.cuh 的 argmax_partial_sm100_kernel 一致。
template <typename T,
          int BATCH_SIZE,
          int CHUNK_SIZE,
